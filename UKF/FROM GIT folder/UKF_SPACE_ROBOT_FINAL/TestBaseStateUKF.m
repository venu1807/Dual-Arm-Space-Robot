...
[y0, t_initial, t_final, incr, rtol, atol, vel_combi_mat]=initials();
...
subplot(3,1,1); hold on; box on;
% plot(t, BaseStateSaved(:,4), 'b-', 'LineWidth', 2);
plot(t, u(:,16), 'g-.', 'LineWidth', 2)
set(gca,'FontSize',12);
xlabel('Time (Seconds)');ylabel('wx(rad/sec)');
% legend('True', 'measured');

subplot(3,1,2); hold on; box on;
% plot(t, BaseStateSaved(:,5), 'b-', 'LineWidth', 2);
plot(t, u(:,17), 'g-.', 'LineWidth', 2)
set(gca,'FontSize',12);
xlabel('Time (Seconds)');ylabel('wy(rad/sec)');
% legend('True', 'measured');

subplot(3,1,3); hold on; box on;
% plot(t, BaseStateSaved(:,6), 'b-', 'LineWidth', 2);
plot(t, u(:,18), 'g-.', 'LineWidth', 2)
set(gca,'FontSize',12);
xlabel('Time (Seconds)');ylabel('wz(rad/sec)');
% legend('True', 'measured');
