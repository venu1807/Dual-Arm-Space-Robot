...
function[Ib,Ibm,M]=verify_coupled_param_mtum(th)

% clear all; close all; clc;

% qr=zeros(6, 1); % Fix an arbitrary pose
qr=[-0.2;-0.3;0;0;0;0];
thr=[0, th']; % Fix arbitrary joint angles
ane=[1; 0; 0];

JP=[0.7, 0.3, 0.5; -0.3, 0.3, 0.5].';%base_arm_joint_sensor_frame_position_sensor_frame
...
[Ib, Ibm, M] = compute_Ib_Ibm(qr,thr,n,alp,a,b,bt,dx,dy,dz,m,Icxx,Icyy,Iczz,Icxy,Icyz,Iczx,JP);
 
prod_term=-inv(Ib)*Ibm;
