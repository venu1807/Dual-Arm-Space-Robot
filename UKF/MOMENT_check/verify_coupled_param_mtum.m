...
thr=[0, 0, 0]; % Fix arbitrary joint angles
ane=[1; 0; 0];
...
% subplot(2,1,2)
% plot(T,mt(:,1))%t vs Px from mtvar.dat file
% 
% figure
% 
% subplot(2,1,1)
...
% subplot(2,1,2)
% plot(T,mt(:,2))%t vs Px from mtvar.dat file
% 
% figure
% 
% subplot(2,1,1)
...
% subplot(2,1,2)
% plot(T,mt(:,6))%t vs Px from mtvar.dat file
% %  plot(T,u(:,15:16))
% 
% 
% 
