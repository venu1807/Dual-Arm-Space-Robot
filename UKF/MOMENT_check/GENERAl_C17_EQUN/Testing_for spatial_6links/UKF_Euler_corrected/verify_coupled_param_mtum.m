...
function[Ib_1,Ibm_1,M]=verify_coupled_param_mtum(u1,u2,u3,u4,u5,u6)

% clear all; close all; clc;

% qr=zeros(6, 1); % Fix an arbitrary pose
qr=[0;0;0;pi/3;pi/6;pi/4];
% qr=[0;0;0;pi/3;pi/4;pi/6];
% thr=[0, ua, ub]; % Fix arbitrary joint angles
thr=[0, u1, u2, u3, u4, u5, u6]; % Fix arbitrary joint angles
...
% [n, nq, alp, a, b, bt, dx, dy, dz, al, alt, m, g,  Icxx, Icyy, Iczz, Icxy, Icyz, Iczx]=inputs_try_set_1();
 ee=n;
[Ib_1, Im_1, Ibm_1, Jbe_1, Jme_1, GJM_1, Jg2_1, MM] = Jacobian_vom(qr,thr,n,alp,a,b,bt,dx,dy,dz,m,Icxx,Icyy,Iczz,Icxy,Icyz,Iczx, ee, ane);
 
prod_term=-inv(Ib_1)*Ibm_1;
