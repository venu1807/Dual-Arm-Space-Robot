...
function[prod_term,M,K]=verify_coupled_param_mtum(ua,ub)
...
% [n, nq, alp, a, b, bt, dx, dy, dz, al, alt, m, g,  Icxx, Icyy, Iczz, Icxy, Icyz, Iczx]=inputs_try_set_1();
 ee=n;
[Ib_1, Im_1, Ibm_1, Jbe_1, Jme_1, GJM_1, Jg2_1, MM,JK] = Jacobian_vom(qr,thr,n,alp,a,b,bt,dx,dy,dz,m,Icxx,Icyy,Iczz,Icxy,Icyz,Iczx, ee, ane);
