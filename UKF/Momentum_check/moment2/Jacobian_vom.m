function [Ib, Im, Ibm, Jbe, Jme, GJM, Jg2 ,MM,JK] = Jacobian_vom(q,th,n,alp,a,b,bt,dx,dy,dz,m,Icxx,Icyy,Iczz,Icxy,Icyz,Iczx,ee,ane)
...
phi1=sym(q(4));th1=sym(q(5));si1=sym(q(6))
;
...
JK=jacobian(H(3:6,:),[phi1,th1,si1]);
