...
function [JJ] = regMat_loop(q,th_d,dq,dth_d,lk_no)
...
% dq=[-4.872189e-08,	 1.132943e-07,	 0.000000e+00,	 8.755216e-07,	 0.000000e+00,	 0.000000e+00,	 -1.426359e-05]	; 
 for t1=1:length(t)
    ...
    v0c = q(t1,9:11)'; %CM linear velocity of the base
    om0 = q(t1,12); %Angular velocity of the base
    dth_d=q(t1,15:16)';
...
U;
V;
% param=[500;500*0.3;500*0.2;10;10*0;10*0.5;10;10*0;10*0.5];
% Pl=U*param
