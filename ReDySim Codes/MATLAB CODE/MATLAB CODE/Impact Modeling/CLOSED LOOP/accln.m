...
syms x0 y0 m0 m1 m2 m3 m4 m11 m12 m13 m14  t
syms lc0 lc1 lc2 lc3 lc4 lc11 lc12 lc13 lc14 
syms th0 th1 th2 th3 th4 th11 th12 th13 th14 
syms l0 l1 l2 l3 l4 l11 l12 l13 l14
syms Izz0 Izz1 Izz2 Izz3 Izz4 Izz11 Izz12 Izz13 Izz14 
syms dx0 dy0 dth0 dth1 dth2 dth3 dth4 dth5 dth6 dth11 dth12 dth13 dth14 dth15 dth16
syms fx0 fy0 tau0 tau1 tau2 tau3 tau4 tau5 tau6  tau11 tau12 tau13 tau14 tau15 tau16


q=[x0;y0;th0;th1;th2;th3;th4;th5;th6; th11; th12; th13; th14; th15; th16];
dq=[dx0; dy0; dth0; dth1; dth2; dth3; dth4; dth5; dth6; dth11; dth12; dth13; dth14; dth15; dth16];
...
c0123456=cos(th0+th1+th2+th3+th4+th5+th6);
s0123456=sin(th0+th1+th2+th3+th4+th5+th6);
...
c0111213141516=cos(th0+th11+th12+th13+th14+th15+th16);
s0111213141516=sin(th0+th11+th12+th13+th14+th15+th16);
...
c50=[x0+lc0*c0+l1*c01+l2*c012+l3*c0123+l4*c01234+lc5*c012345
    ...
    0];
c60=[x0+lc0*c0+l1*c01+l2*c012+l3*c0123+l4*c01234+l5*c012345+lc6*c0123456
    y0+lc0*s0+l1*s01+l2*s012+l3*s0123+l4*s01234+l5*s012345+lc6*s0123456
    0];
...
c150=[x0-lc0*c0+l11*c011+l12*c01112+l13*c0111213+l14*c011121314+lc15*c01112131415
    ...
    0];
c160=[x0-lc0*c0+l11*c011+l12*c01112+l13*c0111213+l14*c011121314+l15*c01112131415+lc16*c0111213141516
    y0-lc0*s0+l11*s011+l12*s01112+l13*s0111213+l14*s011121314+l15*s01112131415+lc16*s0111213141516
    0];
...
w60=[0
    0
    dth0+dth1+dth2+dth3+dth4+dth5+dth6];
...
w160=[0
    0
    dth0+dth11+dth12+dth13+dth14+dth15+dth16];
...
v40(:,i)=diff(c40,q(i));
% v50=[diff(c50,x0) diff(c50,y0) diff(c50,th0) diff(c50,th1) diff(c50,th2)  diff(c50,th3)  diff(c50,th4) diff(c50,th5)  diff(c50,th6) diff(c50,th11) diff(c50,th12)  diff(c50,th13)  diff(c50,th14) diff(c50,th15)  diff(c50,th16)]*dq;
v50(:,i)=diff(c50,q(i));
% v60=[diff(c60,x0) diff(c60,y0) diff(c60,th0) diff(c60,th1) diff(c60,th2)  diff(c60,th3)  diff(c60,th4) diff(c60,th5)  diff(c60,th6) diff(c60,th11) diff(c60,th12)  diff(c60,th13)  diff(c60,th14) diff(c60,th15)  diff(c60,th16)]*dq;
v60(:,i)=diff(c60,q(i));
% 
...
% v150=[diff(c150,x0) diff(c150,y0) diff(c150,th0) diff(c150,th1) diff(c150,th2)  diff(c150,th3)  diff(c150,th4) diff(c150,th5)  diff(c150,th6) diff(c150,th11) diff(c150,th12)  diff(c150,th13)  diff(c150,th14) diff(c150,th15)  diff(c150,th16)]*dq;
v150(:,i)=diff(c150,q(i));
% v160=[diff(c160,x0) diff(c160,y0) diff(c160,th0) diff(c160,th1) diff(c160,th2)  diff(c160,th3)  diff(c160,th4) diff(c160,th5)  diff(c160,th6) diff(c160,th11) diff(c160,th12)  diff(c160,th13)  diff(c160,th14) diff(c160,th15)  diff(c160,th16)]*dq;
v160(:,i)=diff(c160,q(i));
end
...
K160=((m16*v160.'*v160)+(Izz16*w160.'*w160))/2;

%K=simplify(K00+K10+K20+K30+K40+K50+K60+K110+K120+K130+K140+K150+K160);
K=simplify(K00+K10+K20+K30+K40+K110+K120+K130+K140);
