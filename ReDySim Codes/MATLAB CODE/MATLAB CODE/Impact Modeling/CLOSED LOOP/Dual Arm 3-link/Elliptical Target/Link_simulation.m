...
x0=yy00(1); y0=yy00(2); th0=yy00(3); th1=yy00(4); th2=yy00(5); th3=yy00(6); th4=yy00(7); th5=yy00(8);


m0=500;m1=10;m2=10;m3=10;m4=10;m5=10;m6=10; m7=10; l0=1;l1=1;l2=1; l3=2*1.914;  l4=1;l5=1;l6=1; l7=1; lc0=.5*l0;lc1=.5*l1;lc2=.5*l2;lc3=.5*l3; lc4=.5*l4;lc5=.5*l5;lc6=.5*l6; lc7=.5*l7; 
Izz0=83.61; Izz1=1.05; Izz2=1.05; Izz3=2*1.914*1.05; Izz4=1.05; Izz5=1.05; Izz6=1.05; Izz7=1.05;
 
J =[ 0, 0, l3*sin(th0 + th1 + th2 + th3) + l1*sin(th0 + th1) - l4*sin(th0 + th4) + l2*sin(th0 + th1 + th2) - l5*sin(th0 + th4 + th5),   l3*sin(th0 + th1 + th2 + th3) + l1*sin(th0 + th1) + l2*sin(th0 + th1 + th2),   l3*sin(th0 + th1 + th2 + th3) + l2*sin(th0 + th1 + th2),  l3*sin(th0 + th1 + th2 + th3), - l4*sin(th0 + th4) - l5*sin(th0 + th4 + th5), -l5*sin(th0 + th4 + th5)
 0, 0, l4*cos(th0 + th4) - l1*cos(th0 + th1) - l3*cos(th0 + th1 + th2 + th3) - l2*cos(th0 + th1 + th2) + l5*cos(th0 + th4 + th5), - l3*cos(th0 + th1 + th2 + th3) - l1*cos(th0 + th1) - l2*cos(th0 + th1 + th2), - l3*cos(th0 + th1 + th2 + th3) - l2*cos(th0 + th1 + th2), -l3*cos(th0 + th1 + th2 + th3),   l4*cos(th0 + th4) + l5*cos(th0 + th4 + th5),  l5*cos(th0 + th4 + th5)]

yy00(11:18)=(1/10)*[tbf;thdotf(1:5)]; 
...
Ay35=-((pinv(J2)*J1))*[yy00(14);yy00(16:18)]
...
Ay36=-((pinv(J2)*J1))*[yy00(14:15);yy00(17:18)]
...
Ay37=-((pinv(J2)*J1))*[yy00(14:16);yy00(18)]
...
Ay45=-((pinv(J2)*J1))*[yy00(13);yy00(16:18)]
...
Ay46=-((pinv(J2)*J1))*[yy00(13);yy00(15);yy00(17:18)]
...
Ay47=-((pinv(J2)*J1))*[yy00(13);yy00(15:16);yy00(18)]
...
Ay48=-((pinv(J2)*J1))*[yy00(13);yy00(15:17)]
...
Ay56=-((pinv(J2)*J1))*[yy00(13:14);yy00(17:18)]
...
Ay57=-((pinv(J2)*J1))*[yy00(13:14);yy00(16);yy00(18)]
...
Ay58=-((pinv(J2)*J1))*[yy00(13:14);yy00(16:17)]
...
Ay67=-((pinv(J2)*J1))*[yy00(13:15);yy00(18)]
...
Ay68=-((pinv(J2)*J1))*[yy00(13:15);yy00(17)]
...
%
yy00(13)=yy00(13)+Ay34(1)+Ay35(1)+Ay36(1)+Ay37(1)+Ay38(1)
yy00(14)=yy00(14)+Ay34(2)+Ay45(1)+Ay46(1)+Ay47(1)+Ay48(1)
yy00(15)=yy00(15)+Ay35(2)+Ay45(2)+Ay56(1)+Ay57(1)+Ay58(1)
yy00(16)=yy00(16)+Ay36(2)+Ay46(2)+Ay56(2)+Ay67(1)+Ay68(1)
yy00(17)=yy00(17)+Ay37(2)+Ay47(2)+Ay57(2)+Ay67(2)+Ay78(1)
yy00(18)=yy00(18)+Ay38(2)+Ay48(2)+Ay58(2)+Ay68(2)+Ay78(2)


yy00=[Y1(n,1:8).';0;0;tbf;thdotf(1:5)]; 

yy00(11:18)=(eye(8,8)-(pinv(J)*J))*yy00(11:18)
...
hold on
fill([x02 x03 x04 x05 x06 x07],[y02 y03 y04 y05 y06 y07],'g')
hold on

circle = rsmak('circle');
%fnplt(circle), axis square
circ = fncmb(circle,[r 0;0 r/2]);

s=-pi*t/20;
target=fncmb(fncmb(circ, [cos(s) -sin(s);sin(s) cos(s)]), [x01;y01+1.414] );
...
hold on
   ...
   circle = rsmak('circle');
%fnplt(circle), axis square
ellipse = fncmb(circle,[r 0;0 r/2]);
