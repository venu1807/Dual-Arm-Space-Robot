...
[vef thdotf ttf tbf ]=Impact_eqns()
...
l0=1;l1=1;l2=1; l3=2*1.5;  l4=1;l5=1;l6=1; lc0=.5*l0;lc1=.5*l1;lc2=.5*l2;lc3=.5*l3; lc4=.5*l4;lc5=.5*l5;lc6=.5*l6;
...
thdot=pinv(Je)*[vef(1:3);vef(1:3);vef(4:6);vef(4:6)]

%thdot=pinv(Je)*[vef(1);0;0;vef(1);0;0]%;vef(4:5);-vef(6);vef(4:5);-vef(6)]

%yy00(13:18)=thdot(1:6)
...
XX=[x02 x03 x04 x05 x06 x07 x08 x09 (2*x09+x10)/3 x09 x08 x07 x03 x04 x12 x13 x14 (2*x14+x09)/3];
YY=[y02 y03 y04 y05 y06 y07 y08 y09 (2*y09+y10)/3 y09 y08 y07 y03 y04 y12 y13 y14 (2*y14+y09)/3];
