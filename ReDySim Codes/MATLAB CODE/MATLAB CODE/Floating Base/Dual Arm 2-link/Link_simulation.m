...
yy0=[0;0;0; 0.3803; -0.6198; pi-0.3803; 0.6198;0;0;0;0;0;0;0]; 
...
x13=x12+l4*cos(Y(i,3)+Y(i,6)); y13=y12+l4*sin(Y(i,3)+Y(i,6));
x14=x13+l5*cos(Y(i,3)+Y(i,6)+Y(i,7)); y14=y13+l5*sin(Y(i,3)+Y(i,6)+Y(i,7));


XX=[x02 x03 x04 x05 x06 x07 x08 x09 x09 x08 x07 x03 x04 x12 x13 x14];
YY=[y02 y03 y04 y05 y06 y07 y08 y09 y09 y08 y07 y03 y04 y12 y13 y14];
