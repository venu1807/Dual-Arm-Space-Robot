...
XX=[x00 x01 x02 x03 x04 x05 x06 x07 x08 x09];
YY=[y00 y01 y02 y03 y04 y05 y06 y07 y08 y09];
figure(5)
plot(XX,YY,'linewidth',4);
xmin=-1*(l0+l1+l2); xmax=1*(l0+l1+l2); ymin=-1*(l0+l1+l2); ymax=1*(l0+l1+l2);
