...
yy0=[90*pi/180 ;90*pi/180; (88.865)*pi/180; 109.135*pi/180;0;0;0;0;0;0;0;0];
...
m0=500;m1=15;m2=15;m3=15;m4=15;     % m0=500;m1=1.5;m2=5;m3=3;m4=1;  
...
x04=x03+l4*cos(Y(i,2)+Y(i,3)+Y(i,4)); y04=y03+l4*sin(Y(i,2)+Y(i,3)+Y(i,4));
x05=l1*cos(Y(i,1)); y05=l1*sin(Y(i,1));

XX=[x00 x01 x02 x03  x05 x00];
YY=[y00 y01 y02 y03  y05 y00];
