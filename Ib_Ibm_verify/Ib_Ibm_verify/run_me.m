...
figure
subplot(2,1,1)
plot(T,kl(:,1))%t vs vx from GJM file
subplot(2,1,2)
plot(T,u(:,9))%t vs vx from statevar.dat file

%linear velocity along y axis
figure

subplot(2,1,1)
plot(T,kl(:,2))%t vs vy from GJM file
subplot(2,1,2)
plot(T,u(:,10))%t vs vy from statevar.dat file

%angular velocity along z axis
figure

subplot(2,1,1)
plot(T,kl(:,6))%t vs wz from GJM file
subplot(2,1,2)
plot(T,u(:,12))%t vs wz from statevar.dat file
