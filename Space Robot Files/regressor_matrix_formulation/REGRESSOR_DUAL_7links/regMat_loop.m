...
% dq=[-4.872189e-08,	 1.132943e-07,	 0.000000e+00,	 8.755216e-07,	 0.000000e+00,	 0.000000e+00,	 -1.426359e-05]	; 
 for t1=1:length(t)
    ...
    v0c = q(t1,13:15)'; %CM linear velocity of the base
    om0 = q(t1,16); %Angular velocity of the base
    dth_d=q(t1,19:24)';
...
for l=1:3*n
 ...
 U1;
 D;
 param=[500;500*0.3;500*0.2;10;10*0;10*0.5;10;10*0;10*0.5;10;10*0;10*0.5;10;10*0;10*0.5;10;10*0;10*0.5;10;10*0;10*0.5];
%  param=[500;0.2*500;0.3*500;10;0.5*10;0;10;0.5*10;0;10;0.5*10;0;10;0.5*10;0;10;0.5*10;0;10;0.5*10;0];  
 Pl=U*param   
