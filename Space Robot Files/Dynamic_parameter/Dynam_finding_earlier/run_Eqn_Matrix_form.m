...
for t=1:f
        ...
        T12=ddx0 - d1x*ddph0*sin(ph0 + th1) - d1x*ddth1*sin(ph0 + th1) - (a0*ddph0*sin(ph0))/2 - d1x*dph0^2*cos(ph0 + th1)- d1x*dth1^2*cos(ph0 + th1)-(a0*dph0^2*m1*cos(ph0))/2 - 2*d1x*dph0*dth1*cos(ph0 + th1);
...
% % U=table(Tau(:,1),Tau(:,2),Tau(:,3),Tau(:,4),Tau(:,5),'VariableNames',{'Fx' 'Fy' 'Tau0' 'Tau1' 'Tau2'})
...
% %    
% %     fprintf(fip4,'%e ',Tau(j,1),Tau(j,2),Tau(j,3),Tau(j,4),Tau(j,5) );
% %     fprintf(fip4,'\n');
% %     
% % end
