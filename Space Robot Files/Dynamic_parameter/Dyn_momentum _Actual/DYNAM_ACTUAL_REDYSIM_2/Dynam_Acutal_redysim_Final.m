...
th1 = Y(:,7);        %Joint1 position
th2 = Y(:,8);        %Joint2 position
v0cI= Y(:,9:11);    %CM linear velocity of the base
om0 = Y(:,12);       %CM angular velocity of the base
om1 = Y(:,15);       %Joint1 velocity
om2 = Y(:,16);       %Joint2 velocity
...
% C=[A(:,1) A(:,2) A(:,3) A(:,5) A(:,6) A(:,7) A(:,8) A(:,9)];
% 
% d=B-A(:,4);
% 
% A=[];
...
% beq=[];
% 
% lb=[49.5;14.9;9.9;-0.01;0.49;0.9;-0.01;0.49];
% ub=[50.5;15.5;10.5;0.01;0.55;1.1;0.01;0.55];
% 
